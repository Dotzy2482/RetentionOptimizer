...
from ui.coupon_view import CouponView
...
class AboutDialog(QDialog):
    def __init__(self, parent=None):
        ...
        info_lines = [
            ...
            ("Metodoloji:", "Agile (Sprint tabanlı geliştirme)"),
        ]
...
class MainWindow(QMainWindow):
    ...
    def _create_sidebar(self) -> QFrame:
        ...
        # ── About button ──────────────────────────────────────
        about_btn = NavButton("\uE946", "Hakk\u0131nda", checkable=False)
    ...
    def _create_pages(self):
        ...
        # Coupon management
        self.coupon_view = CouponView()
        self.stack.addWidget(self.coupon_view)
